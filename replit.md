...
2. **OurInfluencers** (`artifacts/our-influencers`) — a premium enterprise influencer marketing hub where the operator is the primary admin. Admin-managed accounts, full campaign lifecycle tracking, and anonymous quick-promotion requests.
