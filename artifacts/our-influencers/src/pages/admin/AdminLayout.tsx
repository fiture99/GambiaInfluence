      ...
      <div className="h-16 flex items-center justify-between px-4 border-b border-sidebar-border">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-sm">
            Our<span className="text-sidebar-primary">Influencers</span>
          </span>
        </Link>
        {onClose && (
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="md:hidden h-14 flex items-center px-4 border-b border-border bg-sidebar text-sidebar-foreground">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-sm">Our<span className="text-sidebar-primary">Influencers</span></span>
          </div>
